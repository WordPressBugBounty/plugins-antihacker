...
//$xxx = get_option('antihacker_replace_login_error_msg', '');
//var_dump('xxxxxxxxxxxxxxxxxxxx' . $xxx);
...
if ($antihacker_is_admin) {
  if (get_option('antihacker_was_activated', '0') == '1' && get_option('antihacker_setup_complete', false)) {
