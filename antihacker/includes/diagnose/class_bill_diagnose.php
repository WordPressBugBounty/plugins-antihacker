        ...
        <div class="wrap health-check-body, privacy-settings-body">
            ...
            ORDER BY date";
                ...
                if (count($update_plugins) > 0) {
                    ...
                    //echo '<hr>';
                    echo '<h2 style="color: red;">';
                    echo esc_attr__('Plugins with Updates Available (click to open)', 'antihacker');
                    echo '</h2>';
                    echo '<div>';
                ...
                if ($check_for_bots) {
                    ...
                    if (!empty($rows) && count($rows) > 0) {
                        ...
                        {
                            if ($seconds < 60) {
                                return "$seconds" . " " . esc_attr__("seconds", 'antihacker');
                            } elseif ($seconds < 3600) {
                                return round($seconds / 60) . " " . esc_attr__("minutes", 'antihacker');
                            } elseif ($seconds < 86400) {
                                return round($seconds / 3600) . " " . esc_attr__("hour(s)", 'antihacker');
                            } elseif ($seconds < 604800) {
                                return round($seconds / 86400) . " " . esc_attr__("day(s)", 'antihacker');
                            } elseif ($seconds < 2592000) {
                                return round($seconds / 604800) . " " . esc_attr__("week(s)", 'antihacker');
                            } else {
                                return round($seconds / 2592000) . " " . esc_attr__("month(s)", 'antihacker');
                            }
                        }
                        ...
                        echo '<h2 style="color: red;">';
                        echo esc_attr__('Bots and Hackers Attack (click to open)', 'antihacker');
                        echo '</h2>';
                        echo '<div>';
                        echo esc_attr__('Number of last attacks: ', 'antihacker') . $num_attacks;
                        echo ' in ';
                        ...
                        echo '<br>';
                        //echo '</strong>';
                        esc_attr_e("Bots aren’t human—they’re automated scripts that visit your site. They steal your content, making it less unique. They overload your server, slowing it down and hurting your SEO.", "antihacker");
                        echo '<br>';
                        esc_attr_e("Hackers look for vulnerabilities to access your server. Even small sites are targets—they use your server to send spam and attack others, damaging your IP and email reputation.", "antihacker");
                        echo '<br>';
                        esc_attr_e("If you doubt the accuracy of the table below, check with your hosting provider or check the IPs with the site https://ipinfo.io.", "antihacker");
                        echo '<br>';
                        echo '<br>';
                        echo '<strong>';
                        echo sprintf(
                            __(
                                'Our free <a href="%1$s">antihacker</a> and <a href="%2$s">AntiHacker</a> plugins help safeguard your site.',
                                'antihacker'
                            ),
                            esc_url('https://antihacker.com'),
